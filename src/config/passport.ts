...
// Only register Google OAuth strategy when client ID/secret are configured
if (!env.GOOGLE_CLIENT_ID || !env.GOOGLE_CLIENT_SECRET) {
  console.warn(
    '⚠️ Google OAuth is not configured (missing GOOGLE_CLIENT_ID / GOOGLE_CLIENT_SECRET). Skipping GoogleStrategy registration.'
  );
} else {
  passport.use(
    new GoogleStrategy(
